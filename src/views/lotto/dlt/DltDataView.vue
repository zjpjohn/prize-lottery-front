  ...
  <div style="margin:32px 32px 0 32px">
    <permission permit="super">
      ...
      <div style="margin: 24px 0;display: flex;align-items: center">
        ...
        <el-button size="medium" icon="el-icon-refresh-left" @click="fetchDltData">同步数据</el-button>
        <el-button size="medium" icon="el-icon-s-operation" @click="calcDltHit">命中计算</el-button>
...
import {
  ...
  incrCalcHit,
  rankDataList,
} from "../../../api/dlt-service";
import {dlt_channels, limitName} from "../../../libs/lottery";
