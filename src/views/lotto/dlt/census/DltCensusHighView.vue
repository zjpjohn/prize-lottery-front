...
import {calcRateChart, rateChart} from "../../../../api/dlt-service";
...
export default {
  ...
  methods: {
    ...
    buildChart() {
      ...
      let categories       = this.blue_filter.indexOf(this.query.type) >= 0 ? dlt_blue_categories : dlt_red_categories;
