...
import {fc3dD1D2Filter} from "../../../api/fc3d-service";
import html2canvas from "html2canvas";

export default {
  name: "Fc3dDanFilterView",
  ...
  methods: {
    ...
    fc3dFilterQuery() {
      this.$refs.queryForm.validate(valid => {
        ...
        this.list = [];
        fc3dD1D2Filter(this.query).then(data => this.result = data || []);
      });
    },
    forecastItems(data) {
      if (data.hitData) {
    ...
    downloadPoster() {
      ...
      let name = `fc3d_forecast_${this.selected.period}`;
