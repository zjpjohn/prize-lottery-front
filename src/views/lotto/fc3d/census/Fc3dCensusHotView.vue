...
import {calcFc3dHotChart, getFc3dHotChart} from "../../../../api/fc3d-service";
...
export default {
  ...
  methods: {
    calcHotChart() {
      calcFc3dHotChart(this.period).then(res => {
        this.cancelCalcHot();
        this.queryHotChart();
      })
    },
    ...
    queryHotChart() {
      getFc3dHotChart(this.query.period).then(data => {
        this.census = data;
        this.buildChart();
      })
    },
