...
import {calcFc3dVipChart, getFc3dVipChart} from "../../../../api/fc3d-service";
...
export default {
  ...
  methods: {
    calcVipChart() {
      calcFc3dVipChart(this.period).then(res => {
        this.cancelCalcVip();
        this.queryVipChart();
      });
    },
    ...
    queryVipChart() {
      getFc3dVipChart(this.query).then(data => {
        let {
              period,
              level10,
              level20,
