  ...
  <div style="margin: 32px 32px 0 32px;">
    <div style="display: flex;align-items: center">
      ...
      <el-select clearable v-model="query.hit" placeholder="推荐命中情况" style="width: 180px">
        <el-option label="已命中" value="1"></el-option>
...
import {comRecommendCalc, comRecommendList} from "../../../../api/fc3d-service";

export default {
  name: "Fc3dRecommendListView",
  computed: {
    lottoHits() {
      return lottoHits
    }
  ...
  methods: {
    hitReplace,
    routeToFilter() {
      this.$router.push('/fsd/recommend/filter');
    },
    routeToDetail(row) {
      this.$router.push(`/fsd/recommend/detail/${row.period}`);
    },
    queryRecommends() {
