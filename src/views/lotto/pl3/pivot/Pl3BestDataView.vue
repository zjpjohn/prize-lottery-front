...
import {addPl3Pivot, pl3DanFilter} from "../../../../api/pl3-service";

export default {
  name: "Pl3BestDataView",
  ...
  methods: {
    ...
    pl3FilterQuery() {
      this.$refs.queryForm.validate(valid => {
        ...
        this.list = [];
        pl3DanFilter(this.query).then(data => this.list = data || []);
      });
    },
    savePivot() {
    ...
    downloadPoster() {
      ...
      let name = `pl3_best_${this.selected.period}`;
