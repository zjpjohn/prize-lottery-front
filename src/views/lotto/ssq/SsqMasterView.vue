  ...
  <div style="margin: 32px 32px 0 32px">
    ...
    <permission permit="super">
      <div style="margin-top: 24px">
        ...
        <el-button @click="homeMaster">首页提取</el-button>
        <el-button @click="vipMaster">付费提取</el-button>
        <el-button @click="rankMaster">排名计算</el-button>
        <el-button @click="rateMaster">成绩计算</el-button>
...
import {lastSsqPeriod} from "../../../libs/period";
import {ssq_channels} from "../../../libs/lottery";
  ...
  methods: {
    ...
    rankPeriod() {
      latestRank().then(period => {
        if (period) {
          for (let i = 0; i < 10; i++) {
            this.periods.push(lastSsqPeriod(period, i));
          }
        }
      });
    },
